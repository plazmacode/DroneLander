...
class Player(GameObject):
    ...
    def __init__(self):
        ...
        # this is a mess
        self.image = pygame.image.load("./images/Drone(1).png")
        self.image = pygame.transform.scale(self.image, (self.image.get_width() * 10, self.image.get_height() * 10)).convert_alpha()
        self.base_image = pygame.image.load("./images/Drone(1).png")
        self.base_image = pygame.transform.scale(self.image, (125, 50)).convert_alpha()
